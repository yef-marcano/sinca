...
//! @return An object (a class instance)
  ...
  $this->DisplayPreferences('');
	...
	$this->SetFont('Arial','',6); // Changeable?(not yet...)
...
//! @desc The header is printed in every page.
 ...
 // }//end of 'if usetableheader ...'
   //Logo
    $this->Image('../comunes/images/cab_reportes.jpg',10,10,190);
    //Arial bold 15
...
//! @desc The footer is printed in every page!
  ...
  /*  $this->SetY(-10);
	...
	//Logo
//$this->Code39(10,40,'49d4bfd5c33b7OTI/400/2009',1,5);
$this->Image('../comunes/images/foot_reportes.jpg',10,250,190);
...
//! @desc Prints all list-related buffered info
    ...
    foreach($this->listitem as $item)
    {
        ...
        if ($type == chr(110)) $this->SetFont('zapfdingbats','',4);
        $type .= ' ';
			  ...
			  case 'FONT-SIZE': //Does not support: smaller, larger
			      if(is_numeric($v{0}))
			      {
  			      ...
  			      switch($v)
  			      {
  			         ...
  			         case 'XX-SMALL': $this->SetFontSize( (0.7)* 6);
  			             break;
                 case 'X-SMALL': $this->SetFontSize( (0.77) * 6);
			               break;
			           case 'SMALL': $this->SetFontSize( (0.86)* 6);
  			             break;
  			         case 'MEDIUM': $this->SetFontSize(6);
  			             break;
  			         case 'LARGE': $this->SetFontSize( (1.2)*6);
  			             break;
  			         case 'X-LARGE': $this->SetFontSize( (1.5)*6);
  			             break;
  			         case 'XX-LARGE': $this->SetFontSize( 2*6);
			               break;
              }
            }
			   	  break;
