...
class md_tbldetalle_entrada_almacen {

    var $tableName = "tbldetalle_entrada_almacen";
    var $pkField = "clvcodigo";
    var $sequence = 'tbldetalle_entrada_almacen_clvcodigo_seq';
    var $clvcodigo;
    var $clventrada_almacen;
    var $clvinsumo;
    var $intcantidad;
    var $clvestatus;
    ...
    function insert() {
        ...
        $fields.="clventrada_almacen";
        $fields.=",clvinsumo";
        $fields.=",intcantidad";
        $fields.=",clvestatus";

        $values.="'" . $this->clventrada_almacen . "'";
    ...
    function update() {
        ...
        $fieldsValues.="clventrada_almacen= '" . $this->clventrada_almacen . "'";
