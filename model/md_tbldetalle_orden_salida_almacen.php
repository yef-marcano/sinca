...
class md_tbldetalle_orden_salida_almacen {

    var $tableName = "tbldetalle_orden_salida_almacen";
    var $pkField = "clvcodigo";
    var $sequence = 'tbldetalle_orden_salida_almacen_clvcodigo_seq';
    var $clvcodigo;
    var $clvorden_salida_almacen;
    var $clvinsumo;
    var $intcantidad;
    var $clvestatus;
    ...
    function __construct() {
        $this->clvcodigo = null;
        $this->clvorden_salida_almacen = null;
        $this->clvinsumo = null;
    ...
    function insert() {
        ...
        $fields.="clvorden_salida_almacen";
        $fields.=",clvinsumo";
        $fields.=",intcantidad";
        $fields.=",clvestatus";

        $values.="'" . $this->clvorden_salida_almacen . "'";
    ...
    function update() {
        ...
        $fieldsValues.="clvorden_salida_almacen= '" . $this->clvorden_salida_almacen . "'";
