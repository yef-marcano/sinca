...
class md_tbldetalle_orden_salida_cementera {

    var $tableName = "tbldetalle_orden_salida_cementera";
    var $pkField = "clvcodigo";
    var $sequence = 'tbldetalle_orden_salida_cementera_clvcodigo_seq';
    var $clvcodigo;
    var $clvorden_salida_cementera;
    var $clvinsumo;
    var $intcantidad;
    var $clvestatus;
    ...
    function __construct() {
        $this->clvcodigo = null;
        $this->clvorden_salida_cementera = null;
        $this->clvinsumo = null;
    ...
    function insert() {
        ...
        $fields.="clvorden_salida_cementera";
        $fields.=",clvinsumo";
        $fields.=",intcantidad";
        $fields.=",clvestatus";

        $values.="'" . $this->clvorden_salida_cementera . "'";
    ...
    function update() {
        ...
        $fieldsValues.="clvorden_salida_cementera= '" . $this->clvorden_salida_cementera . "'";
