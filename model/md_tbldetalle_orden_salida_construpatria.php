...
class md_tbldetalle_orden_salida_construpatria {

    var $tableName = "tbldetalle_orden_salida_construpatria";
    var $pkField = "clvcodigo";
    var $sequence = 'tbldetalle_orden_salida_construpatria_clvcodigo_seq';
    var $clvcodigo;
    var $clvorden_salida_construpatria;
    var $clvinsumo;
    var $intcantidad;
    var $clvestatus;
    ...
    function __construct() {
        $this->clvcodigo = null;
        $this->clvorden_salida_construpatria = null;
        $this->clvinsumo = null;
        $this->intcantidad = null;
    ...
    function insert() {
        ...
        $fields.="clvorden_salida_construpatria";
        $fields.=",clvinsumo";
        $fields.=",intcantidad";
        $fields.=",clvestatus";

        $values.="'" . $this->clvorden_salida_construpatria . "'";
        $values.=",'" . $this->clvinsumo . "'";
        $values.=",'" . $this->intcantidad . "'";
        $values.=", 0";
    ...
    function update() {
        ...
        $fieldsValues.="clvorden_salida_construpatria= '" . $this->clvorden_salida_construpatria . "'";
        $fieldsValues.=", clvinsumo= '" . $this->clvinsumo . "'";
        $fieldsValues.=", intcantidad= '" . $this->intcantidad . "'";
