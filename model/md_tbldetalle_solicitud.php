...
class md_tbldetalle_solicitud {

    var $tableName = "tbldetalle_solicitud";
    var $pkField = "clvcodigo";
    var $sequence = 'tbldetalle_solicitud_clvcodigo_seq';
    var $clvcodigo;
    var $clvsolicitud;
    var $clvinsumo;
    var $intcantidad_solicitada;
    var $intcantidad_despachada;
    var $clvunidad_despacho;
    var $clvestatus;
    ...
    function find($condition= "") {
        ...
        $fields.= ", clvsolicitud";
        $fields.= ", clvinsumo";
        $fields.= ", (SELECT u.clvcodigo FROM tblinsumo u WHERE u.clvcodigo= " . $this->tableName . ".clvinsumo) AS nombre_insumo";
        $fields.= ", intcantidad_solicitada";
        $fields.= ", intcantidad_despachada";
        $fields.= ", clvunidad_despacho";
        $fields.= ", clvestatus";
    ...
    function update() {
        ...
        $fieldsValues.=", clvunidad_despacho=" . $this->clvunidad_despacho;
