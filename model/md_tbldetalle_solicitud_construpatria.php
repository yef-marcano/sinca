...
class md_tbldetalle_solicitud_construpatria {

    var $tableName = "tbldetalle_solicitud_construpatria";
    var $pkField = "clvcodigo";
    var $sequence = 'tbldetalle_solicitud_construpatria_clvcodigo_seq';
    var $clvcodigo;
