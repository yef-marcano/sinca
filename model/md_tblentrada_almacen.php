...
class md_tblentrada_almacen {

    var $tableName = "tblentrada_almacen";
    var $pkField = "clvcodigo";
    var $sequence = 'tblentrada_almacen_clvcodigo_seq';
    var $clvcodigo;
    var $clvalmacen;
    var $clvorigen;
    var $dtmfecha;
    ...
    function insert() {
        ...
        $values.= ", " . $this->clvorigen;
        $values.= ", '" . $this->dtmfecha . "'";
        $values.= ", '" . $this->strfactura . "'";
    ...
    function update() {
        ...
        $fieldsValues.="clvalmacen= '" . $this->clvalmacen . "'";
        $fieldsValues.=", clvorigen= '" . $this->clvorigen . "'";
        $fieldsValues.=", dtmfecha= '" . $this->dtmfecha . "'";
        $fieldsValues.=", strfactura= '" . $this->strfactura . "'";
