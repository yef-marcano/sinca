...
class md_tblsolicitud_construpatria {

    var $tableName = "tblsolicitud_construpatria";
    var $pkField = "clvcodigo";
    var $sequence = 'tblsolicitud_construpatria_clvcodigo_seq';
    var $clvcodigo;
    var $clvsolicitud;
