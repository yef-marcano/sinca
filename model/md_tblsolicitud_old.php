...
class md_tblsolicitud {

    var $tableName = "tblsolicitud";
    var $pkField = "clvcodigo";
    var $sequence = 'tblsolicitud_clvcodigo_seq';
    var $clvcodigo;
    var $clvproyecto;
    var $dtmfecha;
    var $memobservacion;
    ...
    function find($condition= "") {
        ...
        $fields.= "clvcodigo";
        $fields.= ", clvproyecto";
        $fields.= ", (SELECT u.strnombre FROM tblproyecto u WHERE u.clvcodigo= " . $this->tableName . ".clvproyecto) AS nombre_proyecto";
        $fields.= ", dtmfecha";
        $fields.= ", memobservacion";
        $fields.= ", clvestatus_solicitud";
        $fields.= ", clvestatus";
    ...
    function update() {
        ...
        $fieldsValues.="clvproyecto= '" . $this->clvproyecto . "'";
