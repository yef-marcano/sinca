...
class md_tblvehiculo {

    var $tableName = "tblvehiculo";
    var $pkField = "clvcodigo";
    var $sequence = 'tblvehiculo_clvcodigo_seq';
    var $clvcodigo;
    var $strplaca;
    var $strplaca_batea;
    var $strmarca;
    ...
    function insert() {
        ...
        $fields.="strplaca";
        $fields.=",strplaca_batea";
        $fields.=",strmarca";
        $fields.=",strcolor";
        $fields.=",clvestatus";

        $values.="'" . $this->strplaca . "'";
        $values.=", '" . $this->strplaca_batea . "'";
        $values.=", '" . $this->strmarca . "'";
        $values.=", '" . $this->strcolor . "'";
        $values.=", 0";
    ...
    function update() {
        ...
        $fieldsValues.="strplaca= '" . $this->strplaca . "'";
        $fieldsValues.=", strplaca_batea= '" . $this->strplaca_batea . "'";
        $fieldsValues.=", strmarca= '" . $this->strmarca . "'";
        $fieldsValues.=", strcolor= '" . $this->strcolor . "'";
