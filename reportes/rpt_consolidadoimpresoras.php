...
class PDF  extends PDF_MC_Table
{
	function Header()
	{
		...
		$this->Cell(0,10,utf8_decode('CONSOLIDADO DE IMPRESORAS AL ').date('d/m/Y'),0,0,'C');
		$this->Ln(10);
...
e.stritema, b.id_categoria_maestro, b.id_estatus_maestro
from tblbienes b, tblmaestros t, tblmaestros e, tblmaestros m, tblmaestros mo
where b.id_categoria_maestro=t.id_maestro and b.id_estatus_maestro=e.id_maestro
...
and b.id_categoria_maestro=94
group by t.stritema, m.stritema, mo.stritema, e.stritema, b.id_categoria_maestro, b.id_estatus_maestro
order by b.id_categoria_maestro,t.stritema,m.stritema,mo.stritema, e.stritema";
$conn= new Conexion();
$conn->abrirConexion();
$conn->sql=$sql;
