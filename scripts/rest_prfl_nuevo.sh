...
echo "cedula primer registro $cedid"
            enc=`mysql -uadmin -pmysql -h192.168.0.96 -P3307 -B --disable-column-names -e "SELECT id_persona FROM bd_saber_trabajo.tbl_personas WHERE cedula = '$cedid'"` # se busca esa ci en la bd principal
echo "encontrado es igual a "$enc            
		...
		mysql -uadmin -pmysql -h192.168.0.96 -P3307 -e "SET FOREIGN_KEY_CHECKS=0;INSERT INTO bd_saber_trabajo.tbl_personas VALUES (NULL, `head -$i $PATH_BCKP/nuevos/Desc/tmp/$ARCHIVO | tail -1 | cut -d, -f2-23 `)"
	    ...
	    echo $v_idp
            ...
            n_idp=`mysql -uadmin -pmysql -h192.168.0.96 -P3307 -B --disable-column-names -e "SELECT id_persona FROM bd_saber_trabajo.tbl_personas WHERE cedula = $cedid"`
        ...
        mysql -u admin -pmysql -h 192.168.0.96 -P 3307 -e "SET FOREIGN_KEY_CHECKS=0;LOAD DATA INFILE '/tmp/tbl_personas_carreras_formarse_tmp.csv' INTO TABLE bd_saber_trabajo.tbl_personas_carreras_formarse FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' (id_persona,id_carrera,estatus,fecha_creacion,fecha_modificacion,fecha_eliminacion,id_usuario_creador,id_usuario_modificar,id_usuario_eliminar)"
        
        
        mysql -u admin -pmysql -h 192.168.0.96 -P 3307 -e "SET FOREIGN_KEY_CHECKS=0;LOAD DATA INFILE '/tmp/tbl_personas_misiones_tmp.csv' INTO TABLE bd_saber_trabajo.tbl_personas_misiones FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' (id_persona,id_mision,estatus,fecha_creacion,fecha_modificacion,fecha_eliminacion,id_usuario_creador,id_usuario_modificar,id_usuario_eliminar)"
        
        
        mysql -u admin -pmysql -h 192.168.0.96 -P 3307 -e "SET FOREIGN_KEY_CHECKS=0;LOAD DATA INFILE '/tmp/tbl_personas_oficios_tmp.csv' INTO TABLE bd_saber_trabajo.tbl_personas_oficios FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' (id_persona,id_oficio,estatus,fecha_creacion,fecha_modificacion,fecha_eliminacion,id_usuario_creador,id_usuario_modificar,id_usuario_eliminar)"
        
        
        mysql -u admin -pmysql -h 192.168.0.96 -P 3307 -e "SET FOREIGN_KEY_CHECKS=0;LOAD DATA INFILE '/tmp/tbl_personas_oficios_formarse_tmp.csv' INTO TABLE bd_saber_trabajo.tbl_personas_oficios_formarse FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' (id_persona,id_oficio,estatus,fecha_creacion,fecha_modificacion,fecha_eliminacion,id_usuario_creador,id_usuario_modificar,id_usuario_eliminar)"
        
        
        mysql -u admin -pmysql -h 192.168.0.96 -P 3307 -e "SET FOREIGN_KEY_CHECKS=0;LOAD DATA INFILE '/tmp/tbl_personas_organizaciones_sociales_tmp.csv' INTO TABLE bd_saber_trabajo.tbl_personas_organizaciones_sociales FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' (id_persona,id_organizacion_social,estatus,fecha_creacion,fecha_modificacion,fecha_eliminacion,id_usuario_creador,id_usuario_modificar,id_usuario_eliminar)"        
        
        
        mysql -u admin -pmysql -h 192.168.0.96 -P 3307 -e "SET FOREIGN_KEY_CHECKS=0;LOAD DATA INFILE '/tmp/tbl_personas_socioeconomicos_tmp.csv' INTO TABLE bd_saber_trabajo.tbl_personas_socioeconomicos FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' (id_persona,id_formacion_academica,posee_certificado,trabaja,estudia,id_carrera,id_profesion,sabe_leer,sabe_escribir,participar_mision,pertenece_organizacion,id_area_laboral,estatus,fecha_creacion,fecha_modificacion,fecha_eliminacion,id_usuario_creador,id_usuario_modificar,id_usuario_eliminar)"
        
        
        mysql -u admin -pmysql -h 192.168.0.96 -P 3307 -e "SET FOREIGN_KEY_CHECKS=0;LOAD DATA INFILE '/tmp/tbl_personas_ubicaciones_tmp.csv' INTO TABLE bd_saber_trabajo.tbl_personas_ubicaciones FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' (id_persona,id_region,id_estado,id_municipio,id_parroquia,id_centro_poblado,nombre_consejo_comunal,id_base_mision,nombre_comuna,direccion,telefono_movil,telefono_fijo,email,twitter,facebook,estatus,fecha_creacion,fecha_modificacion,fecha_eliminacion,id_usuario_creador,id_usuario_modificar,id_usuario_eliminar)"
