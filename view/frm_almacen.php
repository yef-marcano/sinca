...
require('../controller/php/ac_tblalmacen.php');
...
<html>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblAlmacen" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
        ...
        <div id="sideBarFormAlmacen" class="ui very wide styled floating sidebar">
            <div id="divLoader" class="ui disabled dimmer">
                <div class="ui large text loader">Cargando...</div>
            </div>
            <form id="frmAlmacen" name="frmAlmacen" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormAlmacen"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsAlmacen" class="ui top attached tabular menu">
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblalmacen.js"></script>
    </body>
</html>
