...
require('../controller/php/ac_tblcementera.php');
$xajax->setFlag('debug', false);
$xajax->processRequest();
?>
<html>
    <head>
        <title>Cementera</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblCementera" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
        ...
        <div id="sideBarFormCementera" class="ui very wide styled floating sidebar">
            <div id="divLoader" class="ui disabled dimmer">
                <div class="ui large text loader">Cargando...</div>
            </div>
            <form id="frmCementera" name="frmCementera" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormCementera"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsCementera" class="ui top attached tabular menu">
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblcementera.js"></script>
    </body>
</html>
