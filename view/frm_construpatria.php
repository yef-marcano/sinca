...
require('../controller/php/ac_tblconstrupatria.php');
$xajax->setFlag('debug', false);
$xajax->processRequest();
?>
<html>
    <head>
        <title>Centros de Acopio Construpatria</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="ui segment">
            <div class="ui left floated header">
                ...
                Centros de Acopio Construpatria
            </div>
            ...
            <table id="tblConstrupatria" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Descripcion</th>
        ...
        <div id="sideBarFormConstrupatria" class="ui very wide styled floating sidebar">
            <div id="divLoader" class="ui disabled dimmer">
                <div class="ui large text loader">Cargando...</div>
            </div>
            <form id="frmConstrupatria" name="frmConstrupatria" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormConstrupatria"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsConstrupatria" class="ui top attached tabular menu">
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblconstrupatria.js"></script>
