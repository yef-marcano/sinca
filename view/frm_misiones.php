...
require ('../model/md_tblmisiones.php');
...
require('../controller/php/ac_tblmisiones.php');
...
<html>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblMision" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblmisiones.js"></script>
    </body>
</html>
