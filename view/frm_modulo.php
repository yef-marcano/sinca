...
require('../controller/php/ac_tblmodulo.php');
...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblmodulo.js"></script>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblModulo" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
        ...
        <div id="sideBarFormModulo" class="ui very wide styled floating sidebar">
            <div id="divLoader" class="ui disabled dimmer">
                <div class="ui large text loader">Cargando...</div>
            </div>
            <form id="frmModulo" name="frmModulo" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormModulo"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsModulo" class="ui top attached tabular menu">
                    ...
                    <div class="ui active bottom attached tab segment" data-tab="first">
                        ...
                        <div class="field">
                            <label>Icono</label>
                            <div class="ui mini icon input">
                                <input id="txt_icono" name="txt_icono" placeholder="Ingrese el nombre del &iacute;cono" type="text">
                                <i class="icon asterisk"></i>
                            </div>
                        </div>
                        <div class="field">
