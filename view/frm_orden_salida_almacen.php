...
<html>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblOrden_salida_almacen" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                       <th>ID</th>
                        <th>Proyecto</th>
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblorden_salida_almacen.js"></script>
