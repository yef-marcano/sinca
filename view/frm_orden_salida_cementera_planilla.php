...
require ('../model/md_tblorden_salida_cementera.php');
require ('../model/md_tblsolicitud_cementera.php');
require ('../model/md_tbldetalle_solicitud_cementera.php');
...
require('../controller/php/ac_tblorden_salida_cementera.php');
$xajax->setFlag('debug', false);
$xajax->processRequest();
?>
<html>
    <head>
        <title>Orden Salida Cementera</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <form id="frmOrden_salida_cementera_planilla" name="frmOrden_salida_cementera_planilla" action="#" method="post">
            ...
            <div class="ui teal raised secondary fluid segment">
                        <h2 class="ui header"> Orden Salida Cementera</h2>
                    <div class="four fields">
                        ...
                        <div class="field">
                           <label>Solicitud Cementera</label>
                            <select id="txt_solicitud_cementera" name="txt_solicitud_cementera"></select>
                            </div>
...
<!--                       <div class="field">
    ...
    <script type="text/javascript" language="javascript" src="../controller/js/ac_tblorden_salida_cementera_planilla.js"></script>
