...
require ('../model/md_tbldetalle_orden_salida_construpatria.php');
...
<html>
    ...
    <body>
        ...
        <form id="frmOrden_salida_construpatria_planilla" name="frmOrden_salida_construpatria_planilla" action="#" method="post">
            ...
            <div class="ui segment">
                <div id="divForm" class="ui form">
                    <div class="ui teal raised secondary fluid segment">
                        <h2 class="ui header"> Orden Salida Construpatria</h2>
                    <div class="four fields">
                        ...
                        <div class="field">
                           <label>Solicitud Construpatria</label>                             
                            <select id="txt_solicitud_construpatria" name="txt_solicitud_construpatria"></select>
                            </div>
    ...
    <script type="text/javascript" language="javascript" src="../controller/js/ac_tblorden_salida_construpatria_planilla.js"></script>
