...
require('../controller/php/ac_tblperfil.php');
...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblperfil.js"></script>
    ...
    <body>
        ...
        <div id="sideBarFormPerfil" class="ui very wide styled floating sidebar">
            ...
            <form id="frmPerfil" name="frmPerfil" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormPerfil"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsPerfil" class="ui top attached tabular menu">
                        <a class="active item" data-tab="first"><i class="grid layout icon"></i>Datos</a>
                        <a class="item" data-tab="second"><i class="setting icon"></i>Permisos</a>
                        <a class="item" data-tab="third"><i class="browser icon"></i>Auditor&iacute;a</a>
                    </div>
                    ...
                    <div class="ui bottom attached tab segment" data-tab="second">
                        <div id="divAccordionMenus" class="ui accordion"></div>
                    </div>
