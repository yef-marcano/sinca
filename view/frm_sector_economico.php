...
require('../controller/php/ac_tblsector_economico.php');
...
<html>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblSector_economico" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
        ...
        <div id="sideBarFormSector_economico" class="ui very wide styled floating sidebar">
            <div id="divLoader" class="ui disabled dimmer">
                <div class="ui large text loader">Cargando...</div>
            </div>
            <form id="frmSector_economico" name="frmSector_economico" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormSector_economico"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsSector_economico" class="ui top attached tabular menu">
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblsector_economico.js"></script>
    </body>
</html>
