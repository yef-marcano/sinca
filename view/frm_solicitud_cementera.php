...
<html>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblSolicitud_cementera" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Proyecto</th>
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblsolicitud_cementera.js"></script>
        </body>
</html>
