...
<!--                        <div id="btn_aprobar" class="mini ui blue icon submit button">
    ...
    <script type="text/javascript" language="javascript" src="../controller/js/ac_tblsolicitud_planilla.js"></script>
