...
require('../controller/php/ac_tblsolicitud_cementera.php');
...
<html>
            ...
            <div class="ui segment">
                <div id="divForm" class="ui form">
                    <div class="ui teal raised secondary fluid segment">
                        <h2 class="ui header">Solicitud de Cementera</h2>
                    <div class="two fields">
                         <div class="field">
                                <label>Solicitud Numero</label>
                                <div id="divDropDownSolicitud" class="ui fluid selection dropdown">
                                    <input type="hidden" id="txt_solicitud_cementera" name="txt_solicitud_cementera"/>
                                    <div class="default text">Solicitud Nmro</div>
                           ...
                           <div class="field">
                                ...
                                <div id="divDropDownCementera_acopio" class="ui fluid selection dropdown">
                                    ...
                                    <div class="default text">Cementera Acopio</div>
                                    <i class="dropdown icon"></i>
    ...
    <script type="text/javascript" language="javascript" src="../controller/js/ac_tblsolicitud_planilla_cementera.js"></script>
