...
require('../controller/php/ac_tblsubcategoria.php');
...
<html>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblsubCategoria" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Categoria</th>
        ...
        <div id="sideBarFormsubCategoria" class="ui very wide styled floating sidebar">
            <div id="divLoader" class="ui disabled dimmer">
                <div class="ui large text loader">Cargando...</div>
            </div>
            <form id="frmsubCategoria" name="frmsubCategoria" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormsubCategoria"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabssubCategoria" class="ui top attached tabular menu">
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblsubcategoria.js"></script>
    </body>
</html>
