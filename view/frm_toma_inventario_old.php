...
<html>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblToma_inventario" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
        ...
        <div id="sideBarFormToma_inventario" class="ui very wide styled floating sidebar">
            <div id="divLoader" class="ui disabled dimmer">
                <div class="ui large text loader">Cargando...</div>
            </div>
            <form id="frmToma_inventario" name="frmToma_inventario" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormToma_inventario"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsToma_inventario" class="ui top attached tabular menu">
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tbltoma_inventario.js"></script>
    </body>
</html>
