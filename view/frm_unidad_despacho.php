...
require('../controller/php/ac_tblunidad_despacho.php');
$xajax->setFlag('debug', false);
$xajax->processRequest();
?>
<html>
    <head>
        <title>Unidad Despacho</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblUnidad_despacho" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
        ...
        <div id="sideBarFormUnidad_despacho" class="ui very wide styled floating sidebar">
            <div id="divLoader" class="ui disabled dimmer">
                <div class="ui large text loader">Cargando...</div>
            </div>
            <form id="frmUnidad_despacho" name="frmUnidad_despacho" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormUnidad_despacho"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsUnidad_despacho" class="ui top attached tabular menu">
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblunidad_despacho.js"></script>
    </body>
</html>
