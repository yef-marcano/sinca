...
require('../controller/php/ac_tblunidad_medida.php');
...
<html>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblUnidad_medida" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
        ...
        <div id="sideBarFormUnidad_medida" class="ui very wide styled floating sidebar">
            <div id="divLoader" class="ui disabled dimmer">
                <div class="ui large text loader">Cargando...</div>
            </div>
            <form id="frmUnidad_medida" name="frmUnidad_medida" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormUnidad_medida"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsUnidad_medida" class="ui top attached tabular menu">
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblunidad_medida.js"></script>
    </body>
</html>
