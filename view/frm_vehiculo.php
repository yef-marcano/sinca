...
require('../controller/php/ac_tblvehiculo.php');
...
<html>
    ...
    <body>
        <div class="ui segment">
            ...
            <table id="tblVehiculo" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Placa</th>
        ...
        <div id="sideBarFormVehiculo" class="ui very wide styled floating sidebar">
            ...
            <form id="frmVehiculo" name="frmVehiculo" action="#" method="post">
                ...
                <h4 class="ui inverted navy top attached header">
                    <span id="labelFormVehiculo"></span>
                </h4>
                <div id="divForm1" class="ui form attached segment">
                    <div id="tabsVehiculo" class="ui top attached tabular menu">
                    ...
                    <div class="ui active bottom attached tab segment" data-tab="first">
                        <div class="field">
                            ...
                            <div class="ui mini icon input">
                                <input id="txt_placa" name="txt_placa" placeholder="Ingrese la Placa" type="text">
                        ...
                        <div class="field">
                            ...
                            <div class="ui mini icon input">
                                <input id="txt_placa_batea" name="txt_placa_batea" placeholder="Ingrese la Placa Batea" type="text">
                                <i class="icon asterisk"></i>
                            </div>
                        </div>
                        <div class="field">
                            <label>Marca</label>
                            <div class="ui mini icon input">
                                <input id="txt_marca" name="txt_marca" placeholder="Ingrese la Marca" type="text">
                                <i class="icon asterisk"></i>
                            </div>
                        </div>
                        <div class="field">
                            <label>Color</label>
                            <div class="ui mini icon input">
                                <input id="txt_color" name="txt_color" placeholder="Ingrese el Color" type="text">
                                <i class="icon asterisk"></i>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript" language="javascript" src="../controller/js/ac_tblvehiculo.js"></script>
    </body>
</html>
